...
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Olá! Vim pelo site da CoCriart e gostaria de saber mais sobre os serviços."
);
...
export function WhatsAppButton() {
  ...
  // Oculto na página de contato (não duplicar CTA)
    ...
    <LazyMotion features={domAnimation} strict>
      <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
        ...
        <m.span
          ...
          className="pointer-events-none select-none bg-[#1a0829] text-white text-sm font-medium px-3 py-1.5 rounded-lg whitespace-nowrap shadow-lg"
        >
          Fale Conosco
        </m.span>
